...
//!
//! Models the decoder that the ApexRouter Desktop Electron host MUST
...
fn host_drops_plugin_event_silently_per_w8a_h1() {
    let event = ProtocolEvent::PluginEvent {
        plugin_name: "apexrouter-ijfw".into(),
...
fn host_drops_trace_event_silently_under_v0_1_21_decoder() {
    ...
    let lines = [
        r#"{"type": "trace_event", "msg_id": "m-1", "trace": {"turn": 0, "model": "x", "provider": "anthropic", "input_tokens": 1, "output_tokens": 1, "cache_read": 0, "cache_write": 0, "cache_hit_rate": 0.0, "cost_usd": 0.0, "tool_calls": [], "hook_actions": [], "source_product": "apexrouter-cli"}}"#,
