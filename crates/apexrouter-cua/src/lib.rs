//! ApexRouter-Cua — plugin shell for the wcore-cua tool family.
//!
...
//!
//! ```bash
//! rg "wcore-cua|wcore_cua" crates/apexrouter-cua/
//! ```
//!
//! ...must return zero hits.
//!
//! REV-2 audit F7: on Linux ApexRouter with a restricted compositor, the
...
//! `CuaError::ApexRouterRestricted` — rather than silently falling back.

pub mod plugin;

pub use plugin::{MANIFEST_TOML, ApexRouterCua, ApexRouterCuaFactory, default_cua_spec};
