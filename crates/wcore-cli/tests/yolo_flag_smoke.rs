...
fn help_advertises_the_force_flag_as_canonical() {
    ...
    let output = Command::new(binary())
        .arg("--help")
        .output()
        .expect("spawn apexrouter-cli --help");
    assert!(
...
fn clap_accepts_the_force_flag_without_error() {
    ...
    let output = Command::new(binary())
        ...
        .arg("--help")
        .output()
        .expect("spawn apexrouter-cli --force --help");
    assert!(
        output.status.success(),
...
fn clap_accepts_the_yolo_alias() {
    ...
    let output = Command::new(binary())
        ...
        .arg("--help")
        .output()
        .expect("spawn apexrouter-cli --yolo --help");
    assert!(
        output.status.success(),
...
fn clap_accepts_the_dangerously_skip_permissions_alias() {
    ...
    let output = Command::new(binary())
        ...
        .arg("--help")
        .output()
        .expect("spawn apexrouter-cli --dangerously-skip-permissions --help");
    assert!(
        output.status.success(),
