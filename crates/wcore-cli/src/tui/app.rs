...
pub struct App {
    ...
    /// exit), instead of leaking a `apexrouter-rewind-*` directory under the
...
impl App {
    ...
    /// predictable `apexrouter-rewind-<pid>` path under a world-writable `/tmp`:
