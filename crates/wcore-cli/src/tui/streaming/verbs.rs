...
//!
//! The pool is ApexRouter's own voice — gerund-verbs (Claude Code's *grammar*)
...
//!    and re-expressed as ApexRouter gerunds (e.g. Forge's "Brewing fresh bytes"
...
//! 3. **ApexRouter/Hearth/forge originals** — brand-flavored gerunds like
...
/// The streaming verb pool. Each entry is a gerund phrase in ApexRouter's voice:
...
pub static SPINNER_VERBS: &[&str] = &[
    // ── Forge / hearth / smithing originals (ApexRouter brand voice) ──
    "Stoking the forge",
    "Tending the hearth",
    "Tempering the steel",
    "Quenching the blade",
