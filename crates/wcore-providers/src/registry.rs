...
#[derive(Default)]
pub struct ApexRouterProviderRegistry {
    providers: HashMap<String, ProviderFactory>,
}

impl ApexRouterProviderRegistry {
    pub fn new() -> Self {
        Self::default()
    }
...
impl ProviderRegistry for ApexRouterProviderRegistry {
    fn register(&mut self, id: &str, factory: ProviderFactory) -> Result<(), RegistryError> {
        if id.trim().is_empty() {
...
mod tests {
    ...
    fn get_returns_none_for_unknown() {
        let r = ApexRouterProviderRegistry::new();
