...
//! structurally — the surface of `ApexRouterHostSecrets` is the evidence.
...
pub trait ApexRouterHostSecrets: Send + Sync {
...
impl ApexRouterHostSecrets for DenyHostSecrets {
...
impl ApexRouterHostSecrets for GatedHostSecrets {
    fn secret_exists(&self, name: &str) -> bool {
...
mod tests {
    ...
    fn secret_exists_never_exposes_value() {
        ...
        let _: bool = ApexRouterHostSecrets::secret_exists(&g, "S");
