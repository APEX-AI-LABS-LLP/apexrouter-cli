...
//!
//! Wires the bindgen-generated `apexrouter:host/host` import trait to the
//! engine-side adapter traits (`ApexRouterHostHttp`, `ApexRouterHostWorkspace`,
//! `ApexRouterHostSecrets`, `ApexRouterHostTools`, `ApexRouterHostLog`). All
...
use crate::bindings::tool::apexrouter::host::host::{Host, HttpReq, HttpResp};
...
impl Host for HostState {
    ...
    async fn emit_message(&mut self, role: String, text: String) {
        ...
        // later wave once the engine surfaces a `ApexRouterHostChat` trait.
        self.log
