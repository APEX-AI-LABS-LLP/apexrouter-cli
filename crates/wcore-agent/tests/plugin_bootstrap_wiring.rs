...
fn plugin_tool_is_registered_into_the_tool_registry() {
    ...
    outcome
        .tools
        .push(captured("apexrouter-toolful", "fixture_echo"));
...
fn plugin_rule_reaches_the_system_prompt() {
    ...
    let outcome = {
        ...
        o.rules.push(RuleSpec {
            ...
            content: "APEXROUTER_CLI_TASK_1_7_RULE_MARKER must appear".into(),
            scope: RuleScope::Universal,
        });
        o
    };
    ...
    assert!(
        prompt.contains("APEXROUTER_CLI_TASK_1_7_RULE_MARKER"),
