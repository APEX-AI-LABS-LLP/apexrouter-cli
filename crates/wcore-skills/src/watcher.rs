...
impl SkillWatcher {
    ...
    pub fn watch_directory(&mut self, dir: &Path) -> notify::Result<()> {
        ...
        if let Some(ref mut w) = self.watcher {
            ...
            tracing::info!(target: "skills.watcher", dir = %dir.display(), "watching skill directory");
        }
...
fn should_ignore(event: &Event) -> bool {
    ...
    // directory components — otherwise paths like `.apexrouter-cli/skills/SKILL.md`
    // would be incorrectly filtered because `.apexrouter-cli` starts with `.`.
...
mod tests {
    ...
    // -----------------------------------------------------------------------
    // TC-WB-01 [white-box] should_ignore: Access(Read) event -> true
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-02 [white-box] should_ignore: Create event with visible filename -> false
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-03 [white-box] should_ignore: Modify(Any) event with visible filename -> false
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-03b [white-box] should_ignore: Modify(Metadata(_)) -> true (Bug-2 fix)
    //
    ...
    // -----------------------------------------------------------------------
    // TC-WB-04 [white-box] should_ignore: Remove event with visible filename -> false
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-05 [white-box] should_ignore: hidden filename (.swp) -> true
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-06 [white-box] should_ignore: empty paths list -> true (vacuous truth)
    //
    ...
    // -----------------------------------------------------------------------
    // TC-WB-07 [white-box] should_ignore: mixed paths (one visible, one hidden) -> false
    //
    ...
    // -----------------------------------------------------------------------
    // TC-WB-08 [white-box] should_ignore: hidden intermediate dir, visible filename -> false
    //
    ...
    // -----------------------------------------------------------------------
    // TC-WB-09 [white-box] should_ignore: Rename event with visible filename -> false
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-10 [white-box] should_ignore: path with no file_name component -> false
    //
    ...
    // -----------------------------------------------------------------------
    // TC-WB-11 [white-box] watch_directory: duplicate call does not increase count
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-12 [white-box] watch_directory after stop(): watcher is None -> Ok (no panic)
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-13 [white-box] stop() before start() does not panic (debounce_task is None)
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-14 [white-box] watched_dirs() reflects directories added via start()
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-15 [white-box] watched_dirs() is empty after stop()
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // TC-WB-16 [white-box] Drop impl calls stop() - no double-free / no panic
    // -----------------------------------------------------------------------
