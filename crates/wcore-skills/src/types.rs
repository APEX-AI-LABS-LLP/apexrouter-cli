...
// Re-export EffortLevel from wcore-types (single source of truth)
pub use wcore_types::skill_types::EffortLevel;
...
/// W4 X4: a file the skill declares should be written on activation.
/// Template supports `${args.foo}` substitution; path must stay under the
/// skill's CWD.
...
pub struct SkillMetadata {
    ...
    /// W4 X4: artifacts declared in frontmatter, materialised on activation.
