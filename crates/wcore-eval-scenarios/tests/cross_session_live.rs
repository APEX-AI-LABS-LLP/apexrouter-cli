...
//!
//! The masterplan headline. Two SEPARATE `apexrouter-cli` processes share one
//! persistent `APEXROUTER_CLI_HOME`: session 1 is told a fact; session 2 cold-boots
...
#[ignore = "live: two real apexrouter-cli sessions vs real DeepSeek (costs money, needs DEEPSEEK_API_KEY + a pre-built binary)"]
