//! `apexrouter-eval` — CLI driver for the scenario harness.
//!
...
#[derive(Debug, Parser)]
#[command(
    name = "apexrouter-eval",
    about = "scenario eval harness for apexrouter-cli"
)]
struct Cli {
...
fn main() {
    let _cli = Cli::parse();
    eprintln!(
        "apexrouter-eval: T5 will wire the real driver. \
