...
pub struct PluginContext<'a> {
    ...
    /// Wave BR — apexrouter-browser plugin reifies its `BrowserToolSpec` via
    ...
    /// Wave CU — apexrouter-cua plugin reifies its `CuaToolSpec` via this
    ...
    /// v0.6.4 Task 2.1 — apexrouter-honcho (and future user-model backend
