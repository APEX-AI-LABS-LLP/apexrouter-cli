...
// registration shape. Plugin shells (apexrouter-browser) describe their
...
// shape. Plugin shells (apexrouter-cua) describe their desired CUA surface
...
// client. Nothing here names `apexrouter-honcho`.
