//! ApexRouter-IJFW — anchor plugin that exercises every `register_*` surface
//! on [`PluginContext`].
//!
...
pub use plugin::{MANIFEST_TOML, ApexRouterIjfw, ApexRouterIjfwFactory};
