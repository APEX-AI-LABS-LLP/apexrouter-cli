...
(Claude, Gemini, Codex, ApexRouter, Hermes, Cursor, Windsurf, Copilot). Each
platform-specific file (`CLAUDE.md`, `GEMINI.md`, `APEXROUTER.md`, etc.) is a
...
ApexRouter reads `compute_trust` + `compute_net` to set per-project sandbox
