...
#[openapi(
    info(
        title = "apexrouter-cli agent REST API",
        description = "REST + SSE surface over the apexrouter-cli agent engine."
    ),
    paths(
        create_session,
        list_sessions,
...
<title>apexrouter-cli agent REST API</title>
<style>
...
<body>
<h1>apexrouter-cli agent REST API</h1>
