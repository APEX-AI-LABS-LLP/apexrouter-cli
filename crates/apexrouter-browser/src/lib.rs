//! ApexRouter-Browser — plugin shell for the wcore-browser tool family.
//!
...
//!
//! ```bash
//! rg "wcore-browser|wcore_browser" crates/apexrouter-browser/
//! ```
//!
...
pub use plugin::{MANIFEST_TOML, ApexRouterBrowser, ApexRouterBrowserFactory, default_browser_spec};
