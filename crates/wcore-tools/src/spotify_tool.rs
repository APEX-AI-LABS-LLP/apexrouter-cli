...
//!
//! Ported from `apexrouter-hermes/agent/tools/spotify_tool.py` (597 LOC) and
//! the URI/ID normalization helpers from
//! `apexrouter-hermes/agent/tools/providers/spotify_client.py`.
//!
//! The Python original is built on top of a concrete `SpotifyClient`
//! (httpx-based, OAuth token from `apexrouter auth spotify`). ApexRouter's
