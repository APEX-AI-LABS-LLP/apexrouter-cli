...
#[test]
fn v0_6_1_blocks_apexrouter_own_auth_file() {
    assert_refused("cat ~/.config/apexrouter/auth.json");
    assert_refused("cat /home/user/apexrouter/auth.json");
    assert_refused("cat /home/user/apexrouter-cli/credentials.json");
}
