...
//!
//! Covers all three resolver verdicts when the `APEXROUTER_CLI_CONTRADICTION` env
...
//!
//! Tests serialise on a Mutex because `APEXROUTER_CLI_CONTRADICTION` is a
...
const ENV_KEY: &str = "APEXROUTER_CLI_CONTRADICTION";
