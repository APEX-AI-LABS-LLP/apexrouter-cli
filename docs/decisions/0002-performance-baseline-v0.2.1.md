...
Command: `ls -lh target/release/apexrouter-cli`

```
-rwxr-xr-x@ 1 seandonahoe  staff    20M May 15 21:42 target/release/apexrouter-cli
```
...
Command: `time target/release/apexrouter-cli --help` (three runs, BSD
