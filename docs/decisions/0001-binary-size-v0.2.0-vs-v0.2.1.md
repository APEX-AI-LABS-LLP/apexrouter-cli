...
|---|---|---|---|
| `main @ 071c410` (v0.2.0-apexrouter-base) | default release (no explicit `[profile.release]`) | **23 MB** | baseline |
...
ls -lh target/release/apexrouter-cli  # ~23 MB

git checkout feat/wcore-Z0-build-infra
vx cargo build --release -p wcore-cli
ls -lh target/release/apexrouter-cli  # ~19 MB
```
