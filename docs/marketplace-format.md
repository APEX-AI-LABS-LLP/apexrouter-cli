...
ApexRouter-CLI's `apexrouter-cli plugin install <name>` searches a curated,
...
The verified body is cached to `$HOME/.apexrouter/index.json`. Default
...
`apexrouter-cli plugin install <name>` will:
